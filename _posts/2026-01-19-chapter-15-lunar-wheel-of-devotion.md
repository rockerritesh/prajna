---
layout: post
title: "Chapter 15: The Lunar Wheel of Devotion"
date: 2026-04-25
author: "Sumit Yadav [Rocker Ritesh]"
description: "Which tithi belongs to Shiva, Shakti or Vishnu? Projecting the Narada Purana's thirty presiding deities onto the three great streams of Hindu devotion - and finding the lunar month has a rhythm."
source: "https://sumityadav.com.np/posts/2026/04/25/lunar-wheel-of-devotion/"
---

<img src="assets/lunar-wheel-of-devotion/lunar-wheel-hero.png" alt="Krishna playing flute, in Shiva-blue with skull mala and crescent moon, surrounded by Shakti devotees and Kamadhenu cows" width="100%">
...
The trifurcation Shiva–Shakti–Vishnu is the broadest doctrinal partition of Sanatana devotion. The [Shaiva tradition](https://en.wikipedia.org/wiki/Shaivism) centers on Shiva as supreme — consciousness, asceticism, dissolution. The [Shakta tradition](https://en.wikipedia.org/wiki/Shaktism) centers on the Goddess as the source of all manifestation — power, generation, fierce protection. The [Vaishnava tradition](https://en.wikipedia.org/wiki/Vaishnavism) centers on Vishnu as preserver, descending in successive avatars to keep dharma alive.
...
The full input data — every tithi, every Jayanti counted, every weight — is published alongside this post as [`tithi-data.csv`](assets/lunar-wheel-of-devotion/tithi-data.csv) and the script that produces the wheel as [`make_tithi_wheel.py`](assets/lunar-wheel-of-devotion/make_tithi_wheel.py). Disagree with the folding or the weights? Edit them and re-run.

## The plot

![Lunar Wheel of Devotion: 15 tithis colored by dominant stream, with a stacked bar showing exact Shiva/Shakti/Vishnu split](assets/lunar-wheel-of-devotion/tithi-wheel.png)
...
> **→ [Open the interactive wheel](/study/tithi-wheel/)** — hover any tithi to see its Narada Purana deities for both pakshas, the exact (Shiva, Shakti, Vishnu) split, and every Jayanti that lands on it.
...
- [Narada Purana 56.133b–135 — Tithi Devatas (via Medium / Thoughts on Jyotish)](https://medium.com/thoughts-on-jyotish/tithis-the-tithi-devatas-7188a06eedbd) — the scriptural source for the paksha-specific deity list.
- [Tithi article on Wikipedia](https://en.wikipedia.org/wiki/Tithi) — base reference for the tithi as an astronomical and calendrical unit.
- [Panchangam article on Wikipedia](https://en.wikipedia.org/wiki/Panchangam) — the five-limb Hindu calendar; tithi is the first limb.
- [Clickastro — Tithi list and presiding deities](https://www.clickastro.com/blog/tithi-list/) — the alternative "Brihat Samhita-derived" classical list (Pratipada=Brahma, Tritiya=Vishnu, Ekadashi=Rudra, Chaturdashi=Kali). Used as a triangulation source.
- [Astrojyoti — The 16 Tithis](https://www.astrojyoti.com/the-16-tithis-and-their-details.htm) — second triangulation source, aligns with Clickastro on the classical list.
- [Rama Navami (Wikipedia)](https://en.wikipedia.org/wiki/Rama_Navami) — confirms Ram Navami = Shukla Navami of Chaitra.
- [Dashavatara (Wikipedia)](https://en.wikipedia.org/wiki/Dashavatara) — base reference for the ten-avatar list whose Jayantis populate the Vishnu-stream reinforcements.
- [Ekadashi (Wikipedia)](https://en.wikipedia.org/wiki/Ekadashi) — confirms the every-Ekadashi-is-Vishnu Vrat tradition.
- [Shaivism](https://en.wikipedia.org/wiki/Shaivism), [Shaktism](https://en.wikipedia.org/wiki/Shaktism), [Vaishnavism](https://en.wikipedia.org/wiki/Vaishnavism) — base references for the three streams.
